	...
	<main>
		...
		<div class="container">
			<table class="table">
				...
				<tbody>
					<jstl:forEach items="${cliente}" var="c">
						...
						<tr>
							...
							<td><a href="cliente-edit?id=${c.id_cliente}"
								class="btn btn-primary mb-1">Editar</a> <a
								href="cliente-delete?id=${c.id_cliente}"
								onclick="return confirm('Deseja excluir ${c.nome_cliente}?')"
