		...
		<div class="container py-3">
			<form action="./compra-save">
				...
				<input type="hidden" id="id_viagem" name="id_viagem"
					class="form-control" value="${viagem.id_viagem}" />

				<div class="form-group mb-3">
					<label for="id" class="form-label"> Id </label> <input
						type="hidden" id="id" name="id" class="form-control"
						value="${resrva.id_reserva}" />
				</div>

				<div class="form-group mb-3">
					<label for="data" class="form-label"> Data Compra </label> <input
						type="text" id="data" name="data_Compra" class="form-control"
				...
				<div class="form-group mb-3">
					<label for="destinos" class="form-label"> Destinos </label> <select
						...
						<jstl:forEach items="${listaViagens}" var="l">
							<option value="${l.id_viagem}">${l.destino}</option>
						</jstl:forEach>
					</select>
				</div>
				<div class="form-group mb-3">
				...
				<div class="form-group mb-3">
					<label for="total" class="form-label"> Total </label> <input
						type="total" id="total" name="total_Compra" class="form-control"
						value="${reserva.valor_reserva}" />
				</div>
